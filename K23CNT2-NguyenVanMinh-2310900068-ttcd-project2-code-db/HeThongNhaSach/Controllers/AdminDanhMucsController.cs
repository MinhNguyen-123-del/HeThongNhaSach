...
namespace HeThongNhaSach.Controllers
{
    public class AdminDanhMucsController : Controller
    {
        ...
        public AdminDanhMucsController(NhaSachContext context)
        {
            _context = context;
        }
